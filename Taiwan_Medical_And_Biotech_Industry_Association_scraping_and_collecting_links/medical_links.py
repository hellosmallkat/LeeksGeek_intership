...
def is_detail_mode_link(url):
    # Function to check if a URL contains "member.php?"
    return 'member_detail.php?' in url
...
if __name__ == "__main__":
    base_url = "https://www.tmbia.org.tw/member.php?&page="
    all_links = []

    # Loop over each page to scrape links
    for page_num in range(1, 24):  # Assuming there are 5 pages
